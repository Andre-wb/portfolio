...
(function () {
    document.addEventListener('DOMContentLoaded', () => {
         ...
         * ────────────────────────────────────────────────────────── */
        const LAYERS = [
            { cnt: 500, scroll: 0.06, speed: 1, cursor: 0.25, sz: [0.25, 0.8],  al: [0.10, 0.35] },
            { cnt: 250, scroll: 0.18, speed: 3, cursor: 0.60, sz: [0.65, 1.5],  al: [0.28, 0.58] },
            { cnt: 1258, scroll: 0.42, speed: 4, cursor: 1.10, sz: [1.20, 2.6],  al: [0.48, 0.90] },
        ];
